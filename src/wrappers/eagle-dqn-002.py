...
def main():
        ...
        send_src = path.join(cc_repo, 'sender-receiver/sender-receiver/sender_receiver/envs', 'example_DQN_002_msl_25e_rms_lr_0p0001.py') # may have to give model params as arguments
        recv_src = path.join(cc_repo, 'sender-receiver/sender-receiver/sender_receiver/envs', 'run_receiver.py')
        model_name = 'Eagle-DQN-002-model-DQN-msl_25e_rms_lr_0p0001-115iter-rw64.pt'#'model-xentropy-0.01decay10iter-770iter.pt' # change - also look at directories involved
