...
def main():
        ...
        model_name = 'Eagle-Cross-Entropy-001-model-xentropy-60spe_bs_5_pc_70-780iter-rw188.pt'#'model-xentropy-0.01decay10iter-770iter.pt' # change - also look at directories involved
