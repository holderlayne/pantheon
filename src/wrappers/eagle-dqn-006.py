...
def main():
        ...
        send_src = path.join(cc_repo, 'sender-receiver/sender-receiver/sender_receiver/envs', 'example_DQN_006_hl_25e_rms_lr_0p0001.py') # may have to give model params as arguments
        recv_src = path.join(cc_repo, 'sender-receiver/sender-receiver/sender_receiver/envs', 'run_receiver.py')
        model_name = 'Eagle-DQN-006-model-DQN-hl_25e_rms_lr_0p0001-180iter-rw71.pt'#'model-xentropy-0.01decay10iter-770iter.pt' # change - also look at directories involved
